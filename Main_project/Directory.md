...
This is a directory of all files submitted as part of the poster journal, which explains where to find code for each part of our project. 

### Data acquisition
Data used in this project are acquired from ERA5. `GlueingData.py` and `HourlyToDaily.py` are scripts used to concactenate data download in batches and convert hourly data to daily data. 
